...
% OPENEXCEL  Open a file with MS-Excel.
%    OPENEXCEL(FILENAME)  if Excel is installed on the computer, opens file with it.
%
%    OPENEXCEL, by itself, opens a dialog box to select a file opens Excel.
%
%    fullname = OPENEXCEL('find excel.exe')  looks for the excel.exe FILE on "Program Files" folder and,  
