function dirpath = msenvvar(var)
% MSENVVAR  Translate Microsoft's Environment String to a path.
%    MSENVVAR(VAR)  returns corresondding path.
%
%    e.g.:  msenvvar('USERPROFILE')  returns user directory's path.
%
...
if ispc % Windows
    ...
    error('msenvvar is a Winows function.')
