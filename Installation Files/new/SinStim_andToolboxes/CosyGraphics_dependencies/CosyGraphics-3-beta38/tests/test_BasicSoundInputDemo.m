...
% a frequency of 8000 Hz and 2 sound channels for stereo capture.
...
% pahandle = PsychPortAudio('Open', [], 1, 0, 8000, 2);
...
%     wavwrite(transpose(recordedaudio), 8000, 16, wavfilename)
% end
%<\ben>
