% You must be in the Sudoku directory for this to work. <why???>
%
...
%     2013 Benvenuto Jacob,  Suppress beep and clear all (!).
...
% finished making every Sudoku, MATLAB will beep <Suppressed>.
%
% Pressing "ctrl-c" at the command line works to stop the code if you don't
% want to wait for it to finish.
%
...
if any(seed<0)
    ...
    for i=1:N
%         disp(['************************** iteration ',int2str(i),' **************************']) %<ben 15/3/2013: commented>
        [solution,sudoku]=suma(randomSolution,solution,n,-1,s); sudoku, solution %<ben 15/3/2013: print in reverse order>
    ...
    for seed=(seed(:)')
%         disp('************************************************************************') %<ben 15/3/2013: commented>
        [solution,sudoku]=suma(randomSolution,solution,0,seed,s); sudoku, solution %<ben 15/3/2013: print in reverse order>
        sudokuString=mat2str(sudoku);
        sudokuString=strrep(sudokuString,' ','');
        sudokuString=strrep(sudokuString,';','');
        sudokuString=strrep(sudokuString,'[','');
...
% beep %<ben 15/3/2013: commented>
% clear all %<ben 15/3/2013: commented>
