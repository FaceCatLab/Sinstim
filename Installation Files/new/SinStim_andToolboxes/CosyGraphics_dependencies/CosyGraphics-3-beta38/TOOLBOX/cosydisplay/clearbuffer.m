...
% CLEARBUFFER  Erase everything drawn into offscreen. {fast}
...
if b == 0 && ~isempty(COSY_DISPLAY.BUFFERS.BackgroundBuffer)
    copybuffer(COSY_DISPLAY.BUFFERS.BackgroundBuffer,0);
