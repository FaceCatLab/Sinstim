...
%
%    EyeLink's keyboard shortcuts: (work on both Matlab PC and EyeLink PC keyboards)
...
bg = mean(rgb2gray(GLAB_DISPLAY.BackgroundColor));
fg = 1 - round(bg);
...
if ~exist('CalibGrid','var')
    switch SendKey
        ...
        case 'v',   CalibGrid = GLAB_EYELINK.CalibGrid;
        case 'd',   CalibGrid = 'drift';
    end
end
if SendKey == 'c'
    GLAB_EYELINK.CalibGrid = CalibGrid;
end
