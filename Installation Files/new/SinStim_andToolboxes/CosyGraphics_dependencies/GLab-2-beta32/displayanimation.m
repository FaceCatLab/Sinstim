...
% if j==1, t413=time-t0, end
    % Frame errors <takes 60�s to execute on DARTAGNAN>
    nMisses = 0;
    nSkips  = 0;
    if j > 1 % <AVOID THIS !!!>
...
% if ~isabort && nFrameMisses >= 5 + 5*isIsochronous; % Tresh is 5 in std mode and 10 in isochronous mode. <TODO: global var?>
%     str = {'!!! Timing errors !!!';...
%             '';...
