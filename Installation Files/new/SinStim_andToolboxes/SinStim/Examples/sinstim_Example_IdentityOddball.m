...
Gen.Scale = [0.74 0.76 0.78 0.80 0.82 0.84 0.86 0.88 0.90 0.92 0.94 0.96 0.98 1 1.02 1.04 1.06 1.08 1.1 1.12 1.14 1.16 1.18 1.20]; % Image scales. 1=100pc  <v1.3>
...
Gen.FixPoint.ChangedColor = [0 0 1]; % 2d color for color changes.
Gen.FixPoint.ColorChangeDur = 200; %(ms) Duration of change (for both color and shape changes).
...
Gen.Duration = 65; % (sec) Duration of stimulation.
...
ByPart.EventPattern = [1 1 1 1 5]; % Same as events above. Events will be sent at begining of the period (sine min). <v1.5>
