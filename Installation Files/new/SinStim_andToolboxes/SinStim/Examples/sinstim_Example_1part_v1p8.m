...
ByPart.GapBetweenPatterns = [.5 2]; %(sec) [min max]: insert a random gap of between min and max seconds after each pattern. 0: No gap. <v1.8>
...
Gen.Duration = 40; % (sec) Duration of stimulation.
