...
ByPart.Events.SineMin = {3, 8}; % # to send at each sine wave min. 0: Send nothing.
...
Gen.Duration = 12; % (sec) Duration of stimulation.
...
ByPart.WaveFreq = {2, 1.5}; % Sinusoid freq. (Hz). NB: 4 Hz sinusoid = 8 identities per sec!
