...
%   New params v1.3:
%       - Gen.Priority
%       - Gen.Scale <Replaced by Bypart.Scale in v1.8.10 (but still supported for backward compatibility)>
%   New params v1.5:                           Obsolete param v1.5.x:
%       - Gen.isIsochronousMode                     - ByPart.BetweenRepeat
%       - Gen.Events.MissedFrame                    - Gen.ResponseKey <v1.5.3>
%       - Gen.isPhotodiode
...
%   New param v1.8.x:                          Obsolete param v1.8.x:
%       - ByPart.GapBetweenPatterns <v1.8.0>
%       - ByPart.SineWaveStartAngle <v1.8.2>
%       - Gen.FadeOut <v1.8.3>
%       - Gen.FadeIn <v1.8.9>
%       - ByPart.Scale <v1.8.10>                    - Gen.Scale (replace by ByPart.Scale, Gen.Scale still accepted for bw compatibility.> <v1.8.10>
%       - Gen.AllPartsSharingScalesOf  <v1.8.10>
%       - Gen.Events.doForwardKeyboardEvents  <v1.8.12>


%% DISPLAY
% Display:
Gen.Screen = 0; % 1: Full screen display, 2: Display on secondary screen, 0: Display in a window. 
...
% Gen.Scale = [.9 1 1.1]; % <v1.3, Replaced by ByPart.Scale in v1.8.10>
ByPart.Scale = [1]; % Image scales. 1=100pc  <v1.8.10>
Gen.AllPartsSharingScalesOf = 1; % 0: Randomization is done independently for each part. (Default in v1.8.10+). 1: Randomization of scales is done once: all parts use same scale values than part 1 (SinStim's previous behaviour). 2, 3,...: id., sharing scales of part 2 or 3, etc.
...
Gen.Events.doForwardKeyboardEvents = 1; % 1: Forward key press events through // port. 0: Do nothing (default). <v1.8.12>
