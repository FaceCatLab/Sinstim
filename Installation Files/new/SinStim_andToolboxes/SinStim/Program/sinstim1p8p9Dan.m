...
%       - "<SinStim's folder>\Program\Examples\SinStim_Example_1part_v1p*.m" : Uradp-to-date example.  
...
% xy = [0 Gen.FixPoint.Y];
[th,r] = cart2pol(Gen.FixPoint.X,Gen.FixPoint.Y);
...
%% EXPERIMENT!
    ...
    [Times,FrameErr,KeyIDs,KeyPressTimes] = sub_displayanimation(BUFFERS,X,XAlign,Y,YAlign,... <v1.8.3: became a sub-fun>
        ...
        'AxesRotation',THETA,...
        'Scale',Scale,...
        'Draw',FixPointShape,Gen.FixPoint.X,Gen.FixPoint.Y,Gen.FixPoint.Size,FIXPOINTCOLOR,Gen.FixPoint.LineWidth,...
        'Send','parallel',Bytes,...
