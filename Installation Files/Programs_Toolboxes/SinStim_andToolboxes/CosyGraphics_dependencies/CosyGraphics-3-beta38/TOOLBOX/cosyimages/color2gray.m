...
%    color = COLOR2GRAY(color)  Convert rgb vector or M-by-3 matrix 'color' to grayscale.
%    I = COLOR2GRAY(I)          Convert M-by-N-by-3 image matrix 'I' to grayscale.
%
