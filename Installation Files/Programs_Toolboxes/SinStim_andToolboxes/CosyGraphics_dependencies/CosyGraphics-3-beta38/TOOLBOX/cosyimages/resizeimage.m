...
%    
%    I = RESIZEIMAGE(I, [W H]) resizes the image I so that it has W columns and H rows. 
...
% - IMRESIZE waits a [H W] argument; RESIZEIMAGE respects CosyGraphics's convention and waits a [W H]
%   vector.
