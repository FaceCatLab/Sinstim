...
% RGB2HSV Convert red-green-blue colors to hue-saturation-value. (Fixed version of MATLAB function.)
%
...
%   The MathWorks, Inc. 
%   	$Revision: 5.15 $  $Date: 2002/04/09 00:29:50 $
%
%   Ben, 8 Nov. 2007
%		Fix bug: Can be out of [0,1] range due to roundig errors.
%                Output argument are now fitted within range by FITRANGE.
...
s = fitrange(s,[0 1],'cut');
v = fitrange(v,[0 1],'cut');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
