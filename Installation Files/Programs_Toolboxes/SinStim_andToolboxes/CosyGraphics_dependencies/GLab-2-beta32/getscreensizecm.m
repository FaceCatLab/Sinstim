...
% <Programmer note: Unit choice for GLab standard: cm or mm ?
...
global GLAB_DISPLAY GLAB_HARDWARE
...
%% Get screen size
if isfilledfield(GLAB_DISPLAY,'ScreenSize_cm')  % We alread have it..
    wh = GLAB_DISPLAY.ScreenSize_cm;
