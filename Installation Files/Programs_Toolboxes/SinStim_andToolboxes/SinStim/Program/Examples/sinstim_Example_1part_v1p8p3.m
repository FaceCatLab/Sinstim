...
Gen.Scale = [.80 1 1.2]; % Image scales. 1=100pc  <v1.3>
...
Gen.FixPoint.LineWidth = 3; % Line thickness. Set to 0 to get plain square/round.
...
%% EXPERIMENT
% Durations:
Gen.DelayBefore = 5; % (sec) # secs before stim. begin. Use "rand" (e.g.: 5 + 10*rand;) to get random delay. <v1.1>
Gen.Duration = 10; % (sec) Duration of stimulation.
Gen.DelayAfter = 1; % (sec) <v1.1>
Gen.FadeOut = 5; % (sec) <v1.8.3>
...
ByPart.WaveFreq = 2; % Sinusoid freq. (Hz). NB: 4 Hz sinusoid = 8 identities per sec!
