...
%       - Gen.FadeOut <v1.8.3>
%       - Gen.FadeIn <v1.8.9>
%       - ByPart.Scale <v1.8.10, replacing Gen.Scale>
...
ByPart.Scale = [.9 1 1.1]; % Image scales. 1=100pc  <v1.8.10>
Gen.AllPartsSharingScalesOf = 0; % 0: Randomization is done independently for each part. (Default in v1.8.10+). 1: Randomization of scales is done once: all parts use same scale values than part 1 (SinStim's previous behaviour). 2, 3,...: id., sharing scales of part 2 or 3, etc.
